    ...
    $.fn.metro = function(){
        ...
        */
        ...
        $.each(tiles, function(i, e){
            ...
            if(el.css('box-shadow')=='none') el.css({
                'box-shadow':'0 0 1px transparent'
            });
            el.parent().css({
                '-webkit-perspective':el.outerWidth()*20
                });
            el.parent().css({
                '-o-perspective':el.outerWidth()*20
                });
            el.parent().css({
                '-moz-perspective':el.outerWidth()*20
                });
            el.parent().css({
                '-ms-perspective':el.outerWidth()*20
                });
            ...
            el.mousedown(function(e){
                ...
                if( metro.orizorvert > 0 && $.browser.webkit){
                    el
                    .css({
                        '-webkit-transform-origin':(metro.orizorvert==1 ? metro.origin+'% 0%' : '0% '+metro.origin+'%')
                        })
                    .animate({
                    ...
                    .css({
                        '-moz-transform-origin':(metro.orizorvert==1 ? metro.origin+'% 0%' : '0% '+metro.origin+'%')
                        })
                    .css({
                        '-o-transform-origin':(metro.orizorvert==1 ? metro.origin+'% 0%' : '0% '+metro.origin+'%')
                        })
                    .css({
                        '-ms-transform-origin':(metro.orizorvert==1 ? metro.origin+'% 0%' : '0% '+metro.origin+'%')
                        })
                    .css({
                        'transform-origin':(metro.orizorvert==1 ? metro.origin+'% 0%' : '0% '+metro.origin+'%')
                        })
                    .animate({
                        'text-indent':el.css('text-indent')
                        },{
                ...
                if( a.clicking==true ){
                    if( a.orizorvert > 0 && $.browser.webkit){
                        el
                        .css({
                            '-webkit-transform-origin' : (a.orizorvert==1 ? a.origin+'% 0%' : '0% '+a.origin+'%')
                        })
                        .animate({
                            'text-indent':el.css('text-indent')
                            },{
